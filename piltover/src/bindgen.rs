...
AppchainContract < A >
{
    ...
    fn get_use_kzg_da(& self,) -> cainome :: cairo_serde :: call :: FCall < A
    :: Provider, bool >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        []; let __call = starknet :: core :: types :: FunctionCall
        {
            contract_address : self.address, entry_point_selector : starknet
            :: macros :: selector! ("get_use_kzg_da"), calldata : __calldata,
        }; cainome :: cairo_serde :: call :: FCall ::
        new(__call, self.provider(),)
    } #[allow(clippy :: ptr_arg)] #[allow(clippy :: too_many_arguments)] pub
    fn
    ...
    fn
    set_state_getcall(& self, state_root : & starknet :: core :: types ::
    Felt, block_number : & starknet :: core :: types :: Felt, block_hash : &
    starknet :: core :: types :: Felt) -> starknet :: core :: types :: Call
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        [];
        __calldata.extend(starknet :: core :: types :: Felt ::
        cairo_serialize(state_root));
        __calldata.extend(starknet :: core :: types :: Felt ::
        cairo_serialize(block_number));
        __calldata.extend(starknet :: core :: types :: Felt ::
        cairo_serialize(block_hash)); starknet :: core :: types :: Call
        {
            to : self.address, selector : starknet :: macros :: selector!
            ("set_state"), calldata : __calldata,
        }
    } #[allow(clippy :: ptr_arg)] #[allow(clippy :: too_many_arguments)] pub
    fn
    set_state(& self, state_root : & starknet :: core :: types :: Felt,
    block_number : & starknet :: core :: types :: Felt, block_hash : &
    ...
    < A >
    {
        ...
        cairo_serialize(block_number));
        __calldata.extend(starknet :: core :: types :: Felt ::
        cairo_serialize(block_hash)); let __call = starknet :: core :: types
        :: Call
        {
            to : self.address, selector : starknet :: macros :: selector!
            ("set_state"), calldata : __calldata,
    ...
    fn set_use_kzg_da_getcall(& self, use_kzg_da : & bool) -> starknet :: core
    :: types :: Call
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        []; __calldata.extend(bool :: cairo_serialize(use_kzg_da)); starknet
        :: core :: types :: Call
        {
            to : self.address, selector : starknet :: macros :: selector!
            ("set_use_kzg_da"), calldata : __calldata,
        }
    } #[allow(clippy :: ptr_arg)] #[allow(clippy :: too_many_arguments)] pub
    fn set_use_kzg_da(& self, use_kzg_da : & bool) -> starknet :: accounts ::
    ExecutionV3 < A >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        []; __calldata.extend(bool :: cairo_serialize(use_kzg_da)); let __call
        = starknet :: core :: types :: Call
        {
            to : self.address, selector : starknet :: macros :: selector!
            ("set_use_kzg_da"), calldata : __calldata,
...
< P >
{
    ...
    fn get_use_kzg_da(& self,) -> cainome :: cairo_serde :: call :: FCall < P,
    bool >
    {
        use cainome :: cairo_serde :: CairoSerde; let mut __calldata = vec!
        []; let __call = starknet :: core :: types :: FunctionCall
